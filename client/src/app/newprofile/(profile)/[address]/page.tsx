...
import { CreateSubProfile, CreateSubProfileTemplate, Dropdown, PageBanner } from "@root/app/components"
                ...
                <div className="relative flex w-1/4 flex-col">
                    ...
                    <div>
                        <p className="mt-4 leading-relaxed">
                            You like to keep on keeping it on, challenging yourself, testing your skills. This profile shows how skilled you are, let
                            the people know you’re the GOAT.
                        </p>
                    </div>
                ...
                <div className="achievements flex flex-1 flex-col rounded-3xl border border-pink-300 p-4">
                    <div className="p-12">
                        <div className="min-w-44 relative rounded-2xl pb-10">
                            <div className="absolute -inset-px z-0 rounded-2xl bg-gradient-to-r from-yellow-400 to-pink-400" aria-hidden="true"></div>
                    ...
                    <div className="flex items-center justify-start gap-4 ml-12 mb-8">
